  ...
  const applyFilter = () => {
    ...
    if (category.length > 0) {
      productsCopy = productsCopy.filter(item =>
        category.includes(item.category)  // Check if the product's category is in the selected categories
      );
    }

    if (subCategory.length > 0) {
      productsCopy = productsCopy.filter(item =>
        subCategory.includes(item.subCategory)  // Check if the product's Subcategory is in the selected categories
      );
    }
